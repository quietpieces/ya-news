"""
Доступность страниц приложения для анонимных и авторизованных пользователей.

Тестируются следующие аспекты:
- Доступность основных страниц для анонимных клиентов.
- Проверка, что страница логаута не принимает GET-запросы.
- Возможность редактирования и удаления комментариев для автора
  и невозможность для не автора.
- Редирект анонимного клиента на страницу логина при попытке доступа
