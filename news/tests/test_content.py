...
class TestHomePage(TestCase):
    ...
    def setUpTestData(cls):
        # 11 объектов модели News, чтобы проверить что на одной странице
        # будет 10
    ...
    def test_news_count(self):
        ...
        # Получаем все, созданные в setUpTestData, объекты
...
class TestDetailPage(TestCase):
    ...
    def test_comments_order(self):
        ...
        # comment_set - это дефолт related_name модели Comment
